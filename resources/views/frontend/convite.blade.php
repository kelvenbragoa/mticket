    ...
    <div class="ticket">
        <table width="95%">
            <tr>
                <td rowspan="3">
                    <div class="image">
                        <img width="240px" height="240px" src="https://mticket.co.mz/storage/{{$event->image}}" alt="">
                ...
                <td align="center" > 
                    ...
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <span class="june-29">{{date('d-m',strtotime($event->start_date))}}</span>
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <span>{{date('Y',strtotime($event->start_date))}}</span>
                    </p>
                </td>
                <td class="show-name" align="center"><h2>{{$event->name}}</h2></td>
            </tr>
            <tr>
                ...
                <td align="center" class="show-name">
                    ...
                    <h2>{{$customer->name}}</h2>
                    <h2>{{$invite->name}}</h2>
                    <span class="card-ticket">{{$invite->description}}</span>
                    <p class="time">{{date('H:i',strtotime($event->start_time))}}</p>
            ...
            <tr>
                ...
                <td align="center">
                    <p class="location"><span>{{$event->address}},</span>
                        <span>{{$event->province->name}}, Moçambique</span>
                    </p>
                </td>
