                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" placeholder="Telefone/E-mail" value="{{ old('email') }}" required autocomplete="email" autofocus>
