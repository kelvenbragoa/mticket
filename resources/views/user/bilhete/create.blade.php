...
<main id="main" class="site-main listing-main">
    ...
    <div class="listing-content">
        ...
        <h2>Criar bilhete - {{$event->name}}</h2>
        <a href="{{URL::to('/bilhete/'.$event->id.'/evento')}}" title="Genaral"><span class="icon"><i class="la la-angle-left"></i></span><span>Voltar</span></a>
        <form class="upload-form" method="POST" action="{{route('tickets.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="listing-box" id="genaral">
                ...
                <div class="field-group field-select">
                    ...
                    <input type="number" id="price" placeholder="Preço do Bilhete" name="price">
                   
                </div>
                
                <div class="field-group">
                    <h4 class="label">Descrição do bilhete</h4>
                    <textarea type="text" id="description" class="form-control" placeholder="Descrição do Bilhete" name="description" rows="5"></textarea>
                </div>
            ...
            <div class="listing-box" id="horario">
                ...
                <div class="field-inline">
                    <div class="field-group field-select">
                        ...
                        <input type="date" id="start_date" placeholder="Data inicio da venda" name="start_date">
                    </div>
                    <div class="field-group field-select">
                        <label for="price_range">Hora de inicio</label>
                        <input type="time" id="start_time" placeholder="Horas inicio da venda " name="start_time">
                    </div>
                </div>
                ...
                <div class="field-inline">
                    <div class="field-group field-select">
                        ...
                        <input type="date" id="end_date" placeholder="Data termino da venda" name="end_date">
                    </div>
                    <div class="field-group field-select">
                        <label for="price_range">Hora de termino</label>
                        <input type="time" id="end_time" placeholder="Horas termino da venda" name="end_time">
                    </div>
                </div>
            ...
            <div class="listing-box" id="quantidade">
                ...
                <div class="field-group field-select">
                    ...
                    <input type="number" id="max_qtd" placeholder="Quantidade máxima do bilhete" name="max_qtd">
