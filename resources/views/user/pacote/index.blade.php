        ...
        @endif
            <div class="member-place-wrap">
                <div class="member-wrap-top">
                    <h2>Pacotes do Evento - {{$event->name}} ({{$packages->count()}})</h2>  
                </div>
                <!-- .member-wrap-top -->
                ...
                <a href="{{URL::to('/pacote/'.$event->id.'/add')}}" class="btn btn-pill btn-warning mb-3 mt-3"><i class="far fa-plus"></i>Adicionar Pacotes</a>
                ...
                <table class="member-place-list table-responsive">
                    ...
                    <tbody>
                        @forelse ($packages as $item)
                            <tr>
                                ...
                                <td data-title="" class="place-action">
                                    <a href="{{URL::to('/pacote/'.$event->id.'/evento/'.$item->id.'/edit')}}" class="edit" title="Edit"><i class="las la-edit"></i></a>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" align="center">Nenhum Pacote para este evento !</td>
